...
@Composable
fun EmissaotremScreen() {
    var distancia by remember { mutableStateOf("") }
    var combustivel by remember { mutableStateOf("Locomotiva") }
    ...
    Column(
        ...
        Card(
            ...
            Column(
                ...
                Image(
                    painter = painterResource(id = R.drawable.trem),
                    contentDescription = "Imagem de um trem verde",
                    modifier = Modifier.size(300.dp)
                )
                Text("Emissão do trem", fontSize = 20.sp, fontWeight = FontWeight.Bold)
                ...
                Text("Trem:")
                Row {
                    listOf("Locomotiva", "Metrô").forEach { fuel ->
                ...
                Button(
                    onClick = {
                        ...
                        if (dist <= 0) {
                            ...
                            showError = false
                            showResult = calcularCo2Trem(dist, combustivel)
                        }
                    },
...
fun calcularCo2Trem(distancia: Double, tipoTrem: String): Double {
    val fatorEmissao = when(tipoTrem){
        "Locomotiva" -> 2.7
        "Metrô" -> 0.3
        else -> 0.0
    }

    val consumoPorKm = when(tipoTrem){
        "Locomotiva" -> 3.5
        "Metrô" -> 0.5
        else ->0.0
    }
